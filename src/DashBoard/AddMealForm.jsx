...
//         <input  type="submit" value='Add Meal'  className="input input-bordered bg-[#f76042] cursor-pointer text-white" />
//       </div>
...
//        <button  type="submit"   className="input input-bordered cursor-pointer bg-[#f76042] text-white">Add To Upcoming</button>
